...
function Lap() {
  ...
  return (
    <>
      <Container>
        <h1 className="text-center pt-2 pb-3 fw-bold main-f">LapTop</h1>
        <Row>
          {items
            ...
            .map((headset) => (
              <Col style={{ paddingBottom: "25px" }} key={headset.id}>
                <Card style={{ width: "18rem", margin: "0 auto" }}>
                  ...
                  <Card.Body>
                    <Card.Title style={{ height: "60px" }} className="name-f">
                      {headset.title}
                    </Card.Title>
                    <Accordion>
                      <Accordion.Header className="name-f">Click for Details</Accordion.Header>
                      <Accordion.Body>
                        <Card.Text className="main-f">{headset.details}</Card.Text>
                      </Accordion.Body>
                    </Accordion>
