...
function Navbar() {
  ...
  return (
    <>
      <nav className="navbar navbar-expand-lg bg-light d-flex justify-content-center border-bottom border-info main-f">
                ...
                <ul className="dropdown-menu">
                  <li>
                    <Link
                      ...
                      href="#"
                    >
                      Headphone<i className="bi bi-headphones icon-size"></i>
                    </Link>
                  </li>
                  <li>
                    <hr className="dropdown-divider" />
